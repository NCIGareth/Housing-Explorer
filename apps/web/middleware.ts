...
export async function middleware(request: NextRequest) {
  ...
  response.headers.set("Content-Security-Policy", "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vercel.live; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://*.tile.openstreetmap.org; connect-src 'self' https://*.supabase.co https://ws.cso.ie; font-src 'self' data:; frame-src 'self' https://*.vercel.live");
